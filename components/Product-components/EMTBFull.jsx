      ...
      <div className="max-w-[1310px] bg-white flex flex-col-reverse sm:flex-row">
        ...
        <div className="h-full w-full">
          <div className="mt-1 lg:w-auto h-[180px] ">
            <h2 className="text-3xl lg:text-7xl ml-5">EMTB FULL</h2>
            <p className="ml-5 text-lg">Introducing the Opeak eMTB Full: A versatile full-suspension electric mountain bike, perfect for both city streets and outdoor trails. Key highlights include:</p>
        ...
        <div className="h-[330px]  lg:h-full w-full">
          <div className="w-full h-[50%] border border-white">
            <h2 className="ml-5 mt-5 text-color3 text-lg sm:ml-[100px] sm:mt-[100px]">As low as: <span className="text-4xl font-bold text-black">$899.00</span></h2>
                  ...
                  <div className="h-[50px] w-[150px] p-0 flex gap-1">
                    <div className="colors">
                      <ul className='flex'>
                        ...
                        <li>
                          <label>
                            <input type="radio" name="color" value="silver" onChange={(e) => setColor(e.target.value)} />
                            <span className="swatch" style={{ backgroundColor: "silver" }}></span>
                          </label>
                        </li>
                        <li>
                          <label>
