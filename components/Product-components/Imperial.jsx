...
<div className="h-full w-full">
  <div className="mt-1 lg:w-auto h-[180px] ">
    <h2 className="text-3xl lg:text-7xl ml-5">IMPERIAL</h2>
    <p className="ml-5 text-lg">Introducing the "IMPERIAL" eBike: An enhanced version of our "UNIK" model, this 26-inch fat tire electric bike merges moped functionality with notable improvements. Key features include:
...
<div className="h-[330px]  lg:h-full w-full">
  <div className="w-full h-[50%] border border-white">
    <h2 className="ml-5 mt-5 text-color3 text-lg sm:ml-[100px] sm:mt-[100px]">As low as: <span className="text-4xl font-bold text-black">$1,199.00</span></h2>
