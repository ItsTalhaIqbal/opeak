  ...
  return (
    <div className="w-auto max-w-[1310px] h-auto ml-auto mr-auto mt-20">
      <Carousel interval={null}>
        <Carousel.Item>
          <Image height={670} width={1310} src="/supermoto_blue.jpg" id='1' />
        </Carousel.Item>
        <Carousel.Item>
          <Image height={670} width={1310} src="/supermoto_white.jpg" id='2' />
        </Carousel.Item>
        <Carousel.Item>
          <Image height={670} width={1310} src="/supermoto_black.jpg" id='3' />
        </Carousel.Item>
      </Carousel>
...
<div className="h-full w-full">
  <div className="mt-1 lg:w-auto h-[180px] ">
    <h2 className="text-3xl lg:text-7xl ml-5">SUPERMOTO</h2>
...
<div className="h-[330px]  lg:h-full w-full">
  <div className="w-full h-[50%] border border-white">
    <h2 className="ml-5 mt-5 text-color3 text-lg sm:ml-[100px] sm:mt-[100px]">As low as: <span className="text-4xl font-bold">$999.00</span></h2>
